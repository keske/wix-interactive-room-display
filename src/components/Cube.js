        ...
        <div className="cube">
          <div className="back">
            <div className="invert">
              <img
                height={`${size}px`}
                src="http://localhost:3030/cube/back.png"
                width={`${size}px`}
              />
            </div>
          </div>
          <div className="top">
            <div className="invert">
              <img
                height={`${size}px`}
                src="http://localhost:3030/cube/top.png"
                width={`${size}px`}
              />
            </div>
          </div>
          <div className="bottom">
            <div className="invert">
              <img
                height={`${size}px`}
                src="http://localhost:3030/cube/bottom.png"
                width={`${size}px`}
              />
            </div>
          </div>
          <div className="left">
            <div className="invert">
              <img
                height={`${size}px`}
                src="http://localhost:3030/cube/left.png"
                width={`${size}px`}
              />
            </div>
          </div>
          <div className="right">
            <div className="invert">
              <img
                height={`${size}px`}
                src="http://localhost:3030/cube/right.png"
                width={`${size}px`}
              />
            </div>
          </div>
